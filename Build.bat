...
regsvr32 /u "%~dp0target\x86_64-pc-windows-msvc\release\svg_thumbnails_rust.dll"
...
"C:\Program Files (x86)\IObit\IObit Unlocker\IObitUnlocker.exe" /Delete /Normal "%~dp0target\x86_64-pc-windows-msvc\release\svg_thumbnails_rust.dll"
...
regsvr32 "%~dp0target\x86_64-pc-windows-msvc\release\svg_thumbnails_rust.dll"